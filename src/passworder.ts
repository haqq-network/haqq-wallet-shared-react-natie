...
function _generateSalt(byteCount = 32) {
  ...
  return base64.encode(String.fromCharCode.apply(null, view as any));
}
 ...
 */
export const encryptPassworder = async <T extends object>(
  password: string,
  object: T,
): Promise<string> => {
 ...
 */
export const decryptPassworder = async <T extends object>(
  password: string,
